/*1697480532,,JIT Construction: v1009266827,en_US*/
    ...
    (function () {
      ...
      (function () {
        ...
        with (this) {
          ...
          __d(
            "polarisOnDOMReady",
            ["ExecutionEnvironment", "PolarisEventListener"],
            function (a, b, c, d, e, f, g) {
              "use strict";
              var h = null;
              function a() {
  ...
  i.src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        (e.lineNumber || e.line) +
        '","script":"' +
        (e.fileName || e.sourceURL || e.script || "embed.js") +
        '","stack":"' +
        (e.stackTrace || e.stack) +
        '","revision":"1009266827","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
